...
geometry_msgs::Pose2d cordinates;
...
msgs.x=(m.m10/m.m00);
msgs.y=(m.m01/m.m00);
cordinates.x=(msgs.x-cx)/fx;
cordinates.y=(msgs.y-cy)/fy;

pub.publish(cordinates);
}
void frame_tranformer( const sensor_msgs::CameraInfo& info){

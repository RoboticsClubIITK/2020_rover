...
namespace roboiitk::pose_estimation {
    class PoseEstimator{
        ...
        void centreCallback(const geometry_msgs::Point& msg) { centre_coord_ = msg; };
        ...
        void setCamToRoverMatrix(const std::vector<double>& mat) { cam_to_Rover_ = Eigen::Matrix3d(mat.data()).transpose(); };

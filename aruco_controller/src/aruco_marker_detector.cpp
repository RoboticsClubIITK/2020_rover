...
#include <aruco_controller/Centre.h>
#include "aruco.h"
...
int main(int argc, char** argv) {
    ...
    ros::Publisher centre_pub = nh.advertise<aruco_controller::Centre>("/coordinate_topic", 1);
    ...
    while(ros::ok()) {
        ...
        aruco_controller::Centre centre_msg;
...
aruco::MarkerDetector MDetector;
   //detect
   std::vector<aruco::Marker> markers=MDetector.detect(input_image);
